            ...
            case 2: return (
                 <div className="space-y-6">
                    ...
                    <FormSection title="Habitudes de vie & Clinique">
                        ...
                        <FormField label="Poids (kg)" className="sm:col-span-2"><input type="number" value={formData.clinicalInfo.exam.weightKg} onChange={e => handleDataChange('clinicalInfo.exam.weightKg', parseFloat(e.target.value))} /></FormField>
